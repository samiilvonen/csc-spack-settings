...
class LmodCsc(AutotoolsPackage):
    ...
    This copy includes CSC site-specific cache configure options!
    """
    ...
    def configure_args(self):
        ...
        # Here is a CSC specific spider cache configuration
        args.append('--with-spiderCacheDir=/appl/opt/lmod/cache')
        args.append('--with-updateSystemFn=/appl/opt/lmod/system.txt')
