...
class Cdo(AutotoolsPackage):
    ...
    version('1.9.6', '322f56c5e13f525c585ee5318d4435db',
    ...
    depends_on('hdf5+threadsafe+hl~mpi', when='+netcdf')
    ...
    depends_on('hdf5+threadsafe~mpi', when='+hdf5')
    depends_on('hdf5+threadsafe+szip~mpi', when='+hdf5+szip')

    depends_on('udunits2', when='+udunits2')
    depends_on('libxml2', when='+libxml2')
    depends_on('proj@:5', when='+proj')
    depends_on('curl', when='+curl')
    depends_on('fftw@3:~mpi', when='+fftw3')
