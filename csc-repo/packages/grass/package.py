...
class Grass(AutotoolsPackage):
    ...
    version('7.8.0',    '4b1192294e959ffd962282344e4ff325c4472f73abe605e246a1da3beda7ccfa')
    ...
    depends_on('gdal')
    depends_on('python@2.7:2.9', type=('build', 'run'), when='@:7.7.9')
    depends_on('python@3.1:', type=('build', 'run'), when='@7.8.0:')
    depends_on('py-six', type=('build', 'run'), when='@7.8.0:')
    depends_on('libx11')
    depends_on('zstd')
    ...
    # Make py-six visible to the python interpreter
    extends('python')
