...
class Libxc(AutotoolsPackage):
    ...
    version('4.3.3', sha256='30113fe9b7161cfed38675171ab1ebb3e2dfd569d747bdeb49f536295b64b5b6')
...
#                .format(version))
    ...
    def url_for_version(self, version):
        return ("https://gitlab.com/libxc/libxc/-/archive/{0}/libxc-{0}.tar.gz"
                .format(version))
