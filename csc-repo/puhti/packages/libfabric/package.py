...
class Libfabric(AutotoolsPackage):
    ...
    resource(name='fabtests',
             url='https://github.com/ofiwg/libfabric/releases/download/v1.7.2/fabtests-1.7.2.tar.gz',
             sha256='b09e176732adb01289144bbc2fd06ae9c3c9767ea5a2027ab4d9c44fd0164749',
             placement='fabtests', when='@1.7.2')
        
    resource(name='fabtests',
             url='https://github.com/ofiwg/libfabric/releases/download/v1.7.1/fabtests-1.7.1.tar.gz',
             sha256='f94bdbcc4f6453fa80ec2f21ac8bf583dc6332bac4f63f965d12ee78f310f89e',
             placement='fabtests', when='@1.7.1')
    ...
    # Older versions have gz, newer bz2 compression
    def url_for_verion(self, version):
        if version >= Version('1.6.2'):
            url_fmt = "https://github.com/ofiwg/libfabric/releases/download/v{0}/libfabric-{0}.tar.bz2"
        else:
            url_fmt = "https://github.com/ofiwg/libfabric/releases/download/v{0}/libfabric-{0}.tar.gz"
