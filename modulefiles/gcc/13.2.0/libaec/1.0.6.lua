-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-08-16 16:08:46.785641
--
...
setenv("LIBAEC_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/libaec-1.0.6-py22bj")
append_path("MANPATH", "", ":")
