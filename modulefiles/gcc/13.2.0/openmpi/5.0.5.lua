-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-08-16 16:08:46.928593
--
...
prepend_path("MODULEPATH", "/appl/spack/v022/modulefiles/openmpi/5.0.5-tpby2mh/gcc/13.2.0")
...
setenv("OPENMPI_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/openmpi-5.0.5-tpby2m")
setenv("OMPI_MCA_io", "^ompio")
setenv("PMIX_MCA_psec", "^munge")
setenv("SLURM_MPI_TYPE", "pmix_v4")
prepend_path("LD_LIBRARY_PATH", "/appl/spack/v022/install-tree/gcc-13.2.0/openmpi-5.0.5-tpby2m/lib", ":")
append_path("MANPATH", "", ":")
