-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-08-16 16:08:46.138419
--
...
setenv("CDO_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/cdo-2.4.0-gzn5t4")
