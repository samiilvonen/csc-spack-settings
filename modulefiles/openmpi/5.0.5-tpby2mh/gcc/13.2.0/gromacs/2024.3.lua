-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-09-12 10:42:22.010190
--
...
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/gromacs-2024.3-3yarew")
append_path("MANPATH", "", ":")
