-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-11-07 09:33:07.922487
--
...
setenv("GROMACS_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/gromacs-2024.4-bbnrgr")
append_path("MANPATH", "", ":")
