-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-08-16 16:08:46.505201
--
...
setenv("GSL_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/gsl-2.7.1-3czso7")
append_path("MANPATH", "", ":")
