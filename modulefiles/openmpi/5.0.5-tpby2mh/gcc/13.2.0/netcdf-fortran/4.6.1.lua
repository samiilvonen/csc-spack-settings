-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-08-16 16:08:46.884068
--
...
setenv("NETCDF_FORTRAN_INSTALL_ROOT", "/appl/spack/v022/install-tree/gcc-13.2.0/netcdf-fortran-4.6.1-wwft3x")
append_path("MANPATH", "", ":")
