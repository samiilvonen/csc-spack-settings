-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2024-11-11 15:39:49.847502
--
...
depends_on("json-c/0.16")
depends_on("libdeflate/1.18")
depends_on("libgeotiff/1.7.1")
...
depends_on("openjpeg/2.5.0")
depends_on("postgresql/15.2")
